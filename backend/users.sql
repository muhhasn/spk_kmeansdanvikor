-- Tabel users untuk login multi-role
CREATE TABLE users (
...
-- Waka (username: waka, password: waka123)
INSERT INTO users (username, password, role) VALUES ('waka', '$2y$10$Q9Qn1Qn1Qn1Qn1Qn1Qn1QeQn1Qn1Qn1Qn1Qn1Qn1Qn1Qn1Qn1Q', 'waka');
-- Siswa: tidak perlu password, login pakai NISN saja, data nisn diisi sesuai tabel siswa
